...
const translations = {
  es: {
    ...
    features: {
      ...
      subMobile: "Reemplazamos las libretas y las\nhojas de cálculo confusas\ncon herramientas diseñadas para la\nrealidad del campo.",
      items: [
        {
      ...
      >
        <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src={`${getBaseUrl()}/images/logo-icon.png`} alt="laFinca" className="h-9 w-9 object-contain rounded-lg" />
            <span className="font-serif text-2xl tracking-tight text-primary"><span className="font-medium">la</span><span className="font-bold">Finca</span></span>
          </div>
        ...
        <section id="caracteristicas" className="pt-40 pb-24 md:py-24 bg-card border-y border-border">
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <p className="md:hidden text-lg text-muted-foreground whitespace-pre-line">{t.features.subMobile}</p>
              <p className="hidden md:block text-lg text-muted-foreground whitespace-pre-line">{t.features.sub}</p>
            </div>
