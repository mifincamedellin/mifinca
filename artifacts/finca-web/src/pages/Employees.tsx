...
export function Employees() {
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      {/* Add / Edit dialog */}
      <Dialog open={dialogOpen} onOpenChange={(v) => { if (!v) closeDialog(); }} modal={!cropSrc}>
        <DialogContent
      ...
      {/* Photo crop modal — shown when a photo is selected; dialog is set to modal={false} at this point so pointer events are not blocked */}
      {cropSrc && (
        <PhotoCropModal
          src={cropSrc}
